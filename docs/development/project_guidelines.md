...
This document describes general guidelines for the Safe-DS Runner.
...
[src-folder]: https://github.com/Safe-DS/Runner/tree/main/src
[tests-folder]: https://github.com/Safe-DS/Runner/tree/main/tests
